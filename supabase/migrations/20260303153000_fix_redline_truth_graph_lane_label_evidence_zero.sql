-- Ensure redline_truth_graph_v1 reports evidence lane when evidence events are missing
-- but segmentation exists (spans.cnt > 0). Append-only migration: CREATE OR REPLACE.
