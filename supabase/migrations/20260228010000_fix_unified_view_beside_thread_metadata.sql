...
-- Previously these were NULL, causing empty direction badges and placeholder text in UI.
-- Now derives from the most recent sms_messages row matching the phone.
...
-- Now derives last_snippet and last_direction from sms_messages
select
