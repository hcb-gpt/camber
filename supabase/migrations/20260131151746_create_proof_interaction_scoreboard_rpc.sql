...
-- STRAT TURN 68: Scoreboard RPC for replay_call.sh
-- Returns proof metrics for a given interaction_id
...
COMMENT ON FUNCTION proof_interaction_scoreboard IS 
  'STRAT TURN 68: Returns pipeline proof metrics for an interaction. Used by replay_call.sh';
;
